...
namespace WebIcecream_FE_USER.Areas.VNPayAPI.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public ActionResult Payment(string amount, string infor, string orderinfor)
        {
            ...
            pay.AddRequestData("vnp_Amount", (Convert.ToDecimal(amount) * 100 * 25000).ToString());
            // Số tiền cần thanh toán, chuyển đổi thành chuỗi                                                                           // Số tiền cần thanh toán, chuyển đổi thành chuỗi                                                                   //số tiền cần thanh toán, công thức: số tiền * 100 - ví dụ 10.000 (mười nghìn đồng) --> 1000000
